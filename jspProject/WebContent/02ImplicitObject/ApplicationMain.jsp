...
<body>
	...
	초기화 매개변수 : <%= application.getInitParameter("INIT_PARAM") %>	<!-- web.xml에서 INIT_PARAM을 설정하지 않았다면 null을 반환한다. -->

    <h2>서버의 물리적 경로 얻어오기</h2>
    application 내장 객체 : <%= application.getRealPath("/02ImplicitObject") %> <!-- /02ImplicitObject의 물리적 경로를 얻어와서 출력한다. -->
